...
dangereux = Issue.new(title: 'Piste cyclable dangereuse', description: 'Cette piste est trop étroite, elle me fait croiser des automobiles et à chaque fois je manque de tomber, trop étroit.', solution: 'Agrandir la chaussée ou mieux délimiter la piste.', user_id: '5')
